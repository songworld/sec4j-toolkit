...
public class FreeTabPaneComponent extends JPanel {
	// 载入当前资源
...
//	private boolean showCloseButton = true;
	...
	// 构造函数
	public FreeTabPaneComponent(FreeTabPane tab) {
		this(tab, true);
	}

	public FreeTabPaneComponent(FreeTabPane tab, boolean showCloseButton) {
		this.tab = tab;
...
//				FreeTabPaneComponent.this.closeTab();
//			}
//		});
