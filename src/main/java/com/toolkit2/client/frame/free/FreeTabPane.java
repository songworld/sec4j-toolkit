...
public class FreeTabPane extends JTabbedPane {
	...
	private void init() {
		...
		setOpaque(false);
		setUI(new FreeTabPaneUI(this));
		addChangeListener(new ChangeListener() {
			public void stateChanged(ChangeEvent e) {
				FreeTabPane.this.updateTabComponents();
			}
		});
	}
	...
	public void addTab(String title, Component component) {
		...
		FreeTabPaneComponent tabComponent = new FreeTabPaneComponent(this);
